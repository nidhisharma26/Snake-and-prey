...
class S
{
    ...
    bool checkStrangled(int x, int y)
    {
        ...
        glReadPixels
            ...
            //p[0] = R,p[1] = G, p[2] = B
        //printf("Before conversion: %d %d %d \n", p[0], p[1], p[2]);
        //to make the RGB value 1 where color is present and other 0 cyan - 0 1 1 p-> 0 2147483647 2147483647
         p[0]=p[0]/2147483647;
         p[1]=p[1]/2147483647;
         p[2]=p[2]/2147483647;
        ...
        while(temp!=NULL && level!=0)
         {
            ...
            if(temp==head)
            {
              ...
              if(temp==head)
              {
                    if(temp->j>250 && temp->k>590 && temp->j<330 )   //upper blank space (border)
                        temp->q=20;     //upar se nikal kar neeche se enter karega     //setting q coord
                    ...
                    else if(temp->j>150 && temp->j<450 && temp->k>290 && temp->k<330 && level==2) //R1 rectangle
                      {
                            cout<<"\n Crashed with wall \n!!!  Game Over !!!\n";
                            fl=1;op=1;
                            if(level==1)
                      ...
                      else if(temp->j>270 && temp->j<310 && temp->k>150 && temp->k<450 && level==2)//R2 rectangle
                      {
                            cout<<"\n Crashed with wall \n!!!  Game Over !!!\n";
                            if(level==1)
                                    cout<<"\n\tIn EASY Difficulty, Your Score : "<<score*10<<'\n';
                      ...
                      // Upper L
                      else if(temp->j>380 && temp->j<520 && temp->k>390 && temp->k<430 && level==2)//R2 rectangle
                      {
                            cout<<"\n Crashed with wall \n!!!  Game Over !!!\n";
                            if(level==1)
                                    cout<<"\n\tIn EASY Difficulty, Your Score : "<<score*10<<'\n';
                      ...
                      else if(temp->j>380 && temp->j<420 && temp->k>390 && temp->k<530 && level==2)//R2 rectangle
                      {
                            cout<<"\n Crashed with wall \n!!!  Game Over !!!\n";
                            if(level==1)
                                    cout<<"\n\tIn EASY Difficulty, Your Score : "<<score*10<<'\n';
                      ...
                      //Lower L
                       else if(temp->j>70 && temp->j<210 && temp->k>180 && temp->k<220 && level==2)//R2 rectangle
                      {
                            cout<<"\n Crashed with wall \n!!!  Game Over !!!\n";
                            if(level==1)
                                    cout<<"\n\tIn EASY Difficulty, Your Score : "<<score*10<<'\n';
                      ...
                      else if(temp->j>170 && temp->j<210 && temp->k>80 && temp->k<220 && level==2)//R2 rectangle
                      {
                            cout<<"\n Crashed with wall \n!!!  Game Over !!!\n";
                            if(level==1)
                                    cout<<"\n\tIn EASY Difficulty, Your Score : "<<score*10<<'\n';
            ...
            if(temp==head)
                glColor3f(0.8,0.2,0.2);     //Color of HEAD of SNAKE
                //glColor3f(0,0,1);
            ...
            if(temp->p==(x+10) && temp->q==y-10)  //x and y  coordinated of prey
            {
               ++score;
               new_prey();
               t=t-5;               // t check if you have completed the game or not ; check the initialization of t ??
               if(t<20)
               {
                   if(level==1)
